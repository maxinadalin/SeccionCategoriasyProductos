...
DATABASES = {
     "default": env.db("DATABASE_URL", default="postgres:///categoriasyproductos"),
 }
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [#this is the premission that we give to the user
        'rest_framework.permissions.IsAuthenticatedOrReadOnly'#this permission only can read but it cant write
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ),
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',
    'PAGE_SIZE': 12 #esto nos permite paginar nuestras paginas
}


AUTHENTICATION_BACKENDS = ( #this use to make log in the correct way
    'social_core.backends.google.GoogleOAuth2',
    'social_core.backends.facebook.FacebookOAuth2',
    'django.contrib.auth.backends.ModelBackend',
)

SIMPLE_JWT = { #use this so when the user refreshes the page, their information is not lost
...
# This section is used to connect the frontend and backend.
DJOSER = {
    'LOGIN_FIELD': 'email',
...
if not DEBUG:
    DEFAULT_FROM_EMAIL = 'ShoeStore - Tienda de Zapatillas <maxitunn@hotmail.com>'
